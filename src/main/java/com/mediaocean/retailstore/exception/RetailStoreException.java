...
public class RetailStoreException extends RuntimeException implements Serializable {
     ...
     * @param e       - any Throwable
     */
    public RetailStoreException(String message, Throwable e) {
        this(0, message, e);
    }
     ...
     */
    public RetailStoreException(int a_nErrorCode,
                                String a_sModule,
                                String a_sMethod,
                                String a_sComment) {
    ...
    public RetailStoreException(int errorCode,
                                String comment,
                                Throwable throwable) {
    ...
    public RetailStoreException(RestResponse a_restResponse, Throwable cause) {
        m_restResponse = a_restResponse;
        initCause(cause);
    }

    public RetailStoreException(RestResponse a_restResponse, String a_sComment) {
        m_restResponse = a_restResponse;
        m_sComment = a_sComment;
    }
